...
const FALLBACK_PROJECTS = [
    {
        ...
        url: 'https://careerboost-ai-resume-analyzer-yvvikannwf3emtebzaavzo.streamlit.app/',
        description: 'An AI-powered Resume Analyzer that evaluates resumes, calculates ATS scores, identifies missing skills, and provides personalized improvement suggestions.',
    ...
    },
    {
        ...
        description: 'AI-powered emergency healthcare platform providing accident detection, SOS alerts, nearby hospitals, EMR management, and AI medical assistance.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/firebaselogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        id: 'livercirrhosis',
        ...
        description: 'Machine Learning project for predicting liver cirrhosis stages using patient clinical datasets and Random Forest classifiers.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        id: 'ecotrade',
        ...
        description: 'Sustainable circular trading web application developed during the 1M1B internship using modern type-safe standards.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp']
    },
];

const PROJECT_COUNT = 4; // 4 unique projects in sequence
const GAP = 2.5;
