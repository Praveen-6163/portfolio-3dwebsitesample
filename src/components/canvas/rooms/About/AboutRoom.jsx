...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'PRAVEEN', subtitle: '< AI & ML Engineer • Full Stack Developer • Data Enthusiast />' },
    { id: 'focus', position: [0, 0, -55], type: 'awards', title: 'ENGINEERING', subtitle: 'Machine Learning • Intelligent Applications • Web Applications' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Building AI solutions, predictive modeling systems & web portals' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Python • React • Machine Learning • Data Analytics • JavaScript • SQL' },
];
