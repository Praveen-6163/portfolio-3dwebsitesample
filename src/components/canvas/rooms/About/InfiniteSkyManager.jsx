...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Python (Pandas, NumPy, Scikit-Learn)', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Predictive Modeling & ML Algorithms', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Generative AI & LLM Integrations', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Data Analysis & Visualization', date: 'Active', image: '/textures/about/button.webp', url: '#' },
        ],
        platformConfig: {
            label: 'AI / ML',
            color: '#311059',
    ...
    sotd: {
        ...
        items: [
            { label: 'React Frontends & Node.js/Express.js', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Python Streamlit App Deployments', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'MongoDB, Firebase, & MySQL Databases', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'HTML, CSS & JavaScript Essentials', date: 'Active', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'FULL STACK',
            color: '#311059',
    ...
    sotm: {
        ...
        items: [
            { label: 'Git, GitHub, VS Code & Netlify', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Google Cloud Gen AI Academy', date: '2026', image: '/textures/about/button.webp', url: '#' },
            { label: 'AWS Training & Certification', date: '2025', image: '/textures/about/button.webp', url: '#' },
            { label: 'Canva Design & Asset Layouts', date: 'Active', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'TOOLS',
            color: '#311059',
    ...
    other: {
        ...
        items: [
            { label: 'Google Student Ambassador Program', date: '2026', image: '/textures/about/button.webp', url: '#' },
            { label: '1M1B Green Skills Web Dev Internship', date: '2025', image: '/textures/about/button.webp', url: '#' },
            { label: 'SmartBridge AI & ML Virtual Internship', date: '2025', image: '/textures/about/button.webp', url: '#' },
            { label: 'AICTE EduSkills AIML Internship', date: '2025', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'CREDENTIALS',
            color: '#311059',
