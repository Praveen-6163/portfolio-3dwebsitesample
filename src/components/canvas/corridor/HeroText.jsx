...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for PRAVEEN split effect
    const letters = useMemo(() => [
        { char: 'P', baseX: -1.5, splitDir: -2.4 },
        { char: 'R', baseX: -1.0, splitDir: -1.6 },
        { char: 'A', baseX: -0.5, splitDir: -0.8 },
        { char: 'V', baseX: 0.0,  splitDir: 0.0 },
        { char: 'E', baseX: 0.5,  splitDir: 0.8 },
        { char: 'E', baseX: 1.0,  splitDir: 1.6 },
        { char: 'N', baseX: 1.5,  splitDir: 2.4 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: 'AI Engineer', baseX: -1.5, splitDir: -2.0 },
        { text: 'Full Stack', baseX: -0.5, splitDir: -0.7 },
        { text: 'Data Enthusiast', baseX: 0.5, splitDir: 0.7 },
        { text: 'Developer', baseX: 1.5, splitDir: 2.0 },
    ], []);
