    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>Sri Venkata Praveen Medida — AI & Machine Learning Engineer | Full Stack Developer | Data Analytics Enthusiast</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to Sri Venkata Praveen Medida's interactive 3D portfolio. Click or press Enter on the doors to enter.</p>
                )}
