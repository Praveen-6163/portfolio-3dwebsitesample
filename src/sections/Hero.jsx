      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, width: '100%' }}>
        <div className="hero-content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left', maxWidth: '680px' }}>
            ...
            >
              AI & ML Engineer × Full Stack Developer × Data Analytics Enthusiast
            </p>
            ...
            >
              Hi, I'm Sri Venkata Praveen Medida
            </h1>
            ...
            >
              AI & Machine Learning Student passionate about building intelligent applications, AI-powered solutions, data-driven systems, and modern web applications. I enjoy solving real-world problems through Machine Learning, Artificial Intelligence, Data Analytics, and Full Stack Development. My goal is to become a skilled AI Engineer while continuously learning emerging technologies.
            </p>
