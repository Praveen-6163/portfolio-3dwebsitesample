          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                <a
                  href="mailto:praveenmedida42@gmail.com"
                  style={{
                    fontSize: '1.15rem',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', marginTop: '10px' }}>
                ...
                <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', marginTop: '4px' }}>
                  <a
                    href="https://github.com/Praveen-6163"
                  ...
                  <a
                    href="https://www.linkedin.com/in/medida-sri-venkata-praveen"
                    style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}
                    className="contact-item-hover"
